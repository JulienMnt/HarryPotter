...
if (localStorage.getItem('init') !== "1" ) {
    ...
    let hap = createcard("Harry Potter","Gryffondor","hap");
    let heg = createcard("Hermione Granger","Gryffondor","heg");
    let row = createcard("Ron Weasley","Gryffondor","row");
    let ald = createcard("Albus Dumbledore","Gryffondor","ald");
    let hag = createcard("Rubeus Hagrid","Gryffondor","hag");
    let nel = createcard("Neuville Londubat","Gryffondor","nel");
    let sib = createcard("Sirius Black","Gryffondor","sib");
    let mim = createcard("Minerva McGonagall","Gryffondor","mim");
    let rel = createcard("Remus Lupin","Gryffondor","rel");
    let pep = createcard("Peter Pettigrow","Gryffondor","pep");
    let giw = createcard("Ginny Weasley","Gryffondor","giw");
    let vdm = createcard("Voldemort","Serpentard","vdm");
    let drm = createcard("Drago Malfow","Serpentard","drm");
    let ser = createcard("Severus Rogue","Serpentard","ser");
    let doo = createcard("Dolores Ombrage","Serpentard","doo");
    let reb = createcard("Regulus Black","Serpentard","reb");
    let lud = createcard("Luna Dragonneau","Serdaigle","lud");
    let chc = createcard("Cho Chang","Serdaigle","chc");
    let ros = createcard("Rowena Serdaigle","Serdaigle","ros");
    let hes = createcard("Helena Serdaigle","Serdaigle","hes");
    let fif = createcard("Filius Flitwick","Serdaigle","fif");
    let ced = createcard("Cedric Diggory","Poufsouffle","ced");
    let nod = createcard("Norbert Dragonneau","Poufsouffle","nod");
    let nyt = createcard("Nymphadora Tonks","Poufsouffle","nyt");
    let erm = createcard("Ernie Macmillan","Poufsouffle","erm");
